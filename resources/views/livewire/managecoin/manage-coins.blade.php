                                    ...
                                    <tbody>
                                        @forelse ($coins as $coin)
                                            <tr wire:key="{{ $coin->id }}">
                                                ...
                                                <td>
                                                    @if ($coin->image)
                                                        <img src="{{ asset('storage/coins/' . $coin->image) }}"
                                                            alt="Coin Image" class="img-fluid"
                                                ...
                                                <td>
                                                    @forelse ($coin->tags as $tag)
                                                        <span class="badge badge-info">{{ $tag->name }}</span>
                                                    @empty
                                                        <span class="badge badge-warning">No tags available</span>
                                                    @endforelse
                                                </td>

                                                <td>
                                                    @forelse ($coin->links as $link)
                                                        <a href="{{ $link->url }}">
                                                            <span
                                                                class="badge badge-primary">{{ $link->name }}</span>
                                                        </a>
                                                    @empty
                                                        <span class="badge badge-warning">No links available</span>
                                                    @endforelse
                                                </td>
                                                <td>
